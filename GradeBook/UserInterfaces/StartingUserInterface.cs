...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            if (parts.Length != 4)
            {
                Console.WriteLine("Command not valid, Create requires a name, type of gradebook, if it's weighted (false / true).");
                return;
            }
            var name = parts[1];
        ...
        public static void HelpCommand()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("Load 'Name' 'Type' - Loads the gradebook with the provided 'Name' 'Type'.");
            Console.WriteLine();
